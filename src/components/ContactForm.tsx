          ...
          <form onSubmit={handleSubmit} noValidate className='space-y-6'>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-transparent border-b py-2 text-white placeholder-white/20 text-sm outline-none transition-colors ${
                  errors.name
                    ? 'border-red-400/70'
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className={`w-full bg-transparent border-b py-2 text-white placeholder-white/20 text-sm outline-none transition-colors resize-none ${
                  errors.message
                    ? 'border-red-400/70'
                    : 'border-white/20 focus:border-white/60'
                }`}
